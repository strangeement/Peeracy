...
class PeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create peer" do
    assert_difference('Peer.count') do
      post peers_url, params: { peer: { bio: @peer.bio, name: @peer.name, user_id: @peer.user_id } }
    end
  ...
  test "should update peer" do
    patch peer_url(@peer), params: { peer: { bio: @peer.bio, name: @peer.name, user_id: @peer.user_id } }
